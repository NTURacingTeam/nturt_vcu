...
CANOPEN_OD_AGG_TO_MSG_DEFINE(msg_sensor_imu,
...
CANOPEN_OD_AGG_TO_MSG_DEFINE(msg_sensor_wheel,
    AGG_DATA_INIT(0), K_MSEC(10), K_MSEC(8), K_MSEC(3), 0,
    OD_AGG_ENTRY(0x2133,
        OD_AGG_DATA(0x1, int16_t, INV_SPEED_CAN_TO_PHY, AGG_MEMBER(torque.rl)),
        OD_AGG_DATA(0x2, int16_t, INV_TORQUE_CAN_TO_PHY, AGG_MEMBER(speed.rl))
    ),

    OD_AGG_ENTRY(0x2143,
        OD_AGG_DATA(0x1, int16_t, INV_SPEED_CAN_TO_PHY, AGG_MEMBER(torque.rr)),
        OD_AGG_DATA(0x2, int16_t, INV_TORQUE_CAN_TO_PHY, AGG_MEMBER(speed.rr))
    )
);

CANOPEN_OD_AGG_TO_MSG_DEFINE(msg_ts_acc,
...
CANOPEN_OD_AGG_TO_MSG_DEFINE(msg_ts_inv,
    AGG_DATA_INIT(0), K_MSEC(100), K_MSEC(80), K_MSEC(30), 0,
