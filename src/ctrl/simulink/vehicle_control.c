...
void vehicle_control_step(void)
{
  ...
  /* MATLAB Function: '<S29>/MATLAB Function4' incorporates:
   *  Constant: '<S2>/COP_f'
   */
  ...
  /* UnitConversion: '<S81>/Unit Conversion' incorporates:
   *  Gain: '<S40>/Gain4'
   *  Lookup_n-D: '<S40>/Steer_FL'
   *  Lookup_n-D: '<S40>/Steer_FR'
   *  Sum: '<S40>/Add'
   *  Switch: '<S78>/Switch2'
   */
  /* Unit Conversion - from: deg to: rad
   ...
   *  Constant: '<S2>/Ku_target'
   *  Inport generated from: '<Root>/states'
   *  MATLAB Function: '<S46>/reference yaw rate'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   *  UnitDelay: '<S31>/Unit Delay'
   *  UnitDelay: '<S31>/Unit Delay1'
  ...
  rtb_y_g = ((((vehicle_control_DW_l.UnitDelay_DSTATE_b +
              ...
              vehicle_control_DW_l.UnitDelay3_DSTATE_fs) +
  ...
  /* MATLAB Function: '<S2>/FB_Kp' incorporates:
   *  Constant: '<S2>/Ku_target'
   *  Inport generated from: '<Root>/states'
   *  MATLAB Function: '<S2>/FF'
   *  MATLAB Function: '<S2>/MATLAB Function19'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   */
  ...
  /* End of MATLAB Function: '<S2>/FB_Kp' */

  /* MATLAB Function: '<S2>/FB_P' incorporates:
   *  Inport generated from: '<Root>/states'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   *  Sum: '<S2>/Subtract1'
   *  Switch: '<S2>/Switch10'
  ...
  /* End of MATLAB Function: '<S2>/FB_P' */
  ...
  /* DiscreteIntegrator: '<S2>/Discrete-Time Integrator2' incorporates:
   *  MATLAB Function: '<S2>/MATLAB Function19'
   */
  if (rtb_UnitDelay3_j < 0.087266462599716474) {
  ...
  /* MATLAB Function: '<S2>/MATLAB Function18' incorporates:
   *  DiscreteIntegrator: '<S2>/Discrete-Time Integrator2'
   *  Inport generated from: '<Root>/states'
   *  MATLAB Function: '<S2>/FB_Ki1'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   */
  ...
  /* Gain: '<S2>/yaw_inertia1' incorporates:
   *  Sum: '<S2>/Subtract2'
   */
   ...
   *  Inport generated from: '<Root>/cockpit'
   *  Inport generated from: '<Root>/states'
   *  MATLAB Function: '<S2>/MATLAB Function12'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   */
  if (vehicle_control_U.cockpit.brake > 0.1) {
    ...
    /* MATLAB Function: '<S2>/MATLAB Function12' incorporates:
     *  Inport generated from: '<Root>/states'
     *  SignalConversion generated from: '<Root>/Bus Selector1'
     */
  ...
  /* Abs: '<S2>/Abs6' incorporates:
   *  Gain: '<Root>/Gain6'
   *  Inport generated from: '<Root>/wheel'
   */
  rtb_Abs6 = fabs(13.1 * vehicle_control_U.wheel.speed.fl);

  /* Gain: '<S2>/tmax_fr' incorporates:
   *  Abs: '<S2>/Abs6'
  ...
  /* MATLAB Function: '<S2>/torque_distribution' incorporates:
   *  Saturate: '<S2>/Saturation7'
   *  Saturate: '<S2>/Saturation8'
   */
  Fz_f = Fz_r + p_idx_3;
  ...
  /* MATLAB Function: '<S2>/P_limit' incorporates:
   *  Gain: '<S2>/TARGET'
   *  Inport generated from: '<Root>/states'
   *  MATLAB Function: '<S2>/MATLAB Function20'
   *  SignalConversion generated from: '<Root>/Bus Selector1'
   */
  Fz_f = rtb_y_g * 0.62;
  ...
  if (!(t_r_mtr > rtb_Switch2_n0)) {
    /* Product: '<S58>/delta fall limit' incorporates:
     *  SampleTimeMath: '<S58>/sample time'
     *
     * About '<S58>/sample time':
     *  y = K where K = ( w * Ts )
  ...
  /* Update for UnitDelay: '<S38>/Unit Delay4' */
  ...
  /* Update for UnitDelay: '<S41>/Unit Delay6' */
