...
typedef struct {
  ...
  double UD_DSTATE;                    /* '<S11>/UD' */
  double UD_DSTATE_l;                  /* '<S10>/UD' */
...
typedef struct {
   ...
   * Referenced by: '<S22>/SteerWheel to SteerAngle(L)'
   */
   ...
   * Referenced by:
   *   '<S22>/SteerWheel to SteerAngle(L)'
   *   '<S22>/SteerWheel to SteerAngle(R)'
   */
  double pooled4[101];
   ...
   * Referenced by: '<S22>/SteerWheel to SteerAngle(R)'
   */
 ...
 * '<S21>'  : 'vehicle_control/Vehicle Control(TV&TC)/Torque_Max'
 * '<S22>'  : 'vehicle_control/Vehicle Control(TV&TC)/bicycle model steering angle'
 * '<S23>'  : 'vehicle_control/Vehicle Control(TV&TC)/yaw rate reference'
 * '<S24>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function1'
 * '<S25>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function2'
 * '<S26>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function3'
 * '<S27>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function4'
 * '<S28>'  : 'vehicle_control/Vehicle Control(TV&TC)/yaw rate reference/reference yaw rate 1'
 */
