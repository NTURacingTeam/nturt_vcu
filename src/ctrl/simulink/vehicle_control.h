 ...
 * C/C++ source code generated on : Mon Aug 25 18:14:35 2025
 *
...
typedef struct {
  msg_header header;
  msg_header header_g;
  double Memory;                       /* '<S22>/Memory' */
  double Memory1;                      /* '<S22>/Memory1' */
  double target_SR;                    /* '<S22>/target_SR' */
  double Saturation;                   /* '<S22>/Saturation' */
  double Constant1;                    /* '<S3>/Constant1' */
  double RateLimiter1;                 /* '<S3>/Rate Limiter1' */
  double Constant2;                    /* '<S3>/Constant2' */
  double Memory_j;                     /* '<S23>/Memory' */
  double Memory1_p;                    /* '<S23>/Memory1' */
  double target_SR_n;                  /* '<S23>/target_SR' */
  double Saturation_d;                 /* '<S23>/Saturation' */
  double RateLimiter;                  /* '<S3>/Rate Limiter' */
  double Product1;                     /* '<S4>/Product1' */
  double Product;                      /* '<S4>/Product' */
  double tc_on;                        /* '<S23>/MATLAB Function' */
  double tc_on_l;                      /* '<S22>/MATLAB Function' */
  double y;                            /* '<S21>/MATLAB Function5' */
  double y_f;                          /* '<S20>/MATLAB Function5' */
  double y_i;                          /* '<S19>/MATLAB Function5' */
  double y_p;                          /* '<S18>/MATLAB Function5' */
  double y_m;                          /* '<S17>/MATLAB Function5' */
  double y_e;                          /* '<S16>/MATLAB Function5' */
  double SR_r;                         /* '<S4>/MATLAB Function4' */
  double SR_l;                         /* '<S4>/MATLAB Function4' */
  double Memory_PreviousInput;         /* '<S22>/Memory' */
  double Memory1_PreviousInput;        /* '<S22>/Memory1' */
  double TimeStampA;                   /* '<S22>/Derivative' */
  double LastUAtTimeA;                 /* '<S22>/Derivative' */
  double TimeStampB;                   /* '<S22>/Derivative' */
  double LastUAtTimeB;                 /* '<S22>/Derivative' */
  double PrevY;                        /* '<S3>/Rate Limiter1' */
  double LastMajorTime;                /* '<S3>/Rate Limiter1' */
  double Memory_PreviousInput_p;       /* '<S23>/Memory' */
  double Memory1_PreviousInput_c;      /* '<S23>/Memory1' */
  double TimeStampA_g;                 /* '<S23>/Derivative' */
  double LastUAtTimeA_k;               /* '<S23>/Derivative' */
  double TimeStampB_i;                 /* '<S23>/Derivative' */
  double LastUAtTimeB_e;               /* '<S23>/Derivative' */
  double PrevY_o;                      /* '<S3>/Rate Limiter' */
  double LastMajorTime_l;              /* '<S3>/Rate Limiter' */
  double Memory2_PreviousInput;        /* '<S16>/Memory2' */
  double Memory1_PreviousInput_m;      /* '<S16>/Memory1' */
  double Memory_PreviousInput_k;       /* '<S16>/Memory' */
  double Memory3_PreviousInput;        /* '<S16>/Memory3' */
  double Memory2_PreviousInput_c;      /* '<S18>/Memory2' */
  double Memory1_PreviousInput_a;      /* '<S18>/Memory1' */
  double Memory_PreviousInput_d;       /* '<S18>/Memory' */
  double Memory3_PreviousInput_e;      /* '<S18>/Memory3' */
  double Memory2_PreviousInput_f;      /* '<S20>/Memory2' */
  double Memory1_PreviousInput_mi;     /* '<S20>/Memory1' */
  double Memory_PreviousInput_m;       /* '<S20>/Memory' */
  double Memory2_PreviousInput_e;      /* '<S17>/Memory2' */
  double Memory1_PreviousInput_n;      /* '<S17>/Memory1' */
  double Memory_PreviousInput_a;       /* '<S17>/Memory' */
  double Memory3_PreviousInput_o;      /* '<S17>/Memory3' */
  double Memory2_PreviousInput_h;      /* '<S19>/Memory2' */
  double Memory1_PreviousInput_nw;     /* '<S19>/Memory1' */
  double Memory_PreviousInput_j;       /* '<S19>/Memory' */
  double Memory3_PreviousInput_c;      /* '<S19>/Memory3' */
  double Memory2_PreviousInput_m;      /* '<S21>/Memory2' */
  double Memory1_PreviousInput_d;      /* '<S21>/Memory1' */
  double Memory_PreviousInput_o;       /* '<S21>/Memory' */
...
typedef struct {
   ...
   * Referenced by: '<S24>/SteerWheel to SteerAngle(L)'
   */
   ...
   * Referenced by:
   *   '<S24>/SteerWheel to SteerAngle(L)'
   *   '<S24>/SteerWheel to SteerAngle(R)'
   */
  double pooled8[101];
   ...
   * Referenced by: '<S24>/SteerWheel to SteerAngle(R)'
   */
 ...
 * '<S13>'  : 'vehicle_control/Vehicle Control(TV&TC)/MATLAB Function4'
 * '<S14>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem'
 * '<S15>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1'
 * '<S16>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem2'
 * '<S17>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem3'
 * '<S18>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem4'
 * '<S19>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem5'
 * '<S20>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem6'
 * '<S21>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem7'
 * '<S22>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RL'
 * '<S23>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RR'
 * '<S24>'  : 'vehicle_control/Vehicle Control(TV&TC)/bicycle model steering angle'
 * '<S25>'  : 'vehicle_control/Vehicle Control(TV&TC)/yaw rate reference'
 * '<S26>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function1'
 * '<S27>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function2'
 * '<S28>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function3'
 * '<S29>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function4'
 * '<S30>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem2/MATLAB Function5'
 * '<S31>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem3/MATLAB Function5'
 * '<S32>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem4/MATLAB Function5'
 * '<S33>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem5/MATLAB Function5'
 * '<S34>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem6/MATLAB Function5'
 * '<S35>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem7/MATLAB Function5'
 * '<S36>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RL/MATLAB Function'
 * '<S37>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RL/MATLAB Function1'
 * '<S38>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RR/MATLAB Function'
 * '<S39>'  : 'vehicle_control/Vehicle Control(TV&TC)/Traction Control RR/MATLAB Function1'
