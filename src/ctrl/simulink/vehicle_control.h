...
typedef struct {
   ...
   * Referenced by: '<S20>/SteerWheel to SteerAngle(L)'
   */
   ...
   * Referenced by:
   *   '<S20>/SteerWheel to SteerAngle(L)'
   *   '<S20>/SteerWheel to SteerAngle(R)'
   */
  double pooled5[101];
   ...
   * Referenced by: '<S20>/SteerWheel to SteerAngle(R)'
   */
 ...
 * '<S15>'  : 'vehicle_control/Vehicle Control(TV&TC)/MATLAB Function'
 * '<S16>'  : 'vehicle_control/Vehicle Control(TV&TC)/MATLAB Function1'
 * '<S17>'  : 'vehicle_control/Vehicle Control(TV&TC)/MATLAB Function2'
 * '<S18>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem'
 * '<S19>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1'
 * '<S20>'  : 'vehicle_control/Vehicle Control(TV&TC)/bicycle model steering angle'
 * '<S21>'  : 'vehicle_control/Vehicle Control(TV&TC)/yaw rate reference'
 * '<S22>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function1'
 * '<S23>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function2'
 * '<S24>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function3'
 * '<S25>'  : 'vehicle_control/Vehicle Control(TV&TC)/Subsystem1/MATLAB Function4'
 * '<S26>'  : 'vehicle_control/Vehicle Control(TV&TC)/yaw rate reference/reference yaw rate 1'
 */
